...
const en: Dict = {
  ...
  'lp.roicalc.min': 'min',
  'lp.roicalc.salary': 'Operator’s monthly salary',
  'lp.roicalc.operators': 'Number of operators',
  'lp.roicalc.minutes': 'AI-handled minutes / month',
  'lp.roicalc.assumes':
    'AI handles calls in parallel with no shift limits — you pay only for the minutes used.',
  'lp.roicalc.humanCost': 'Your monthly wage bill',
  'lp.roicalc.aiCost': 'CallMind AI — usage',
  'lp.roicalc.saving': 'You save / month',
  ...
  'lp.price.title': 'Pay per minute — top up and go',
  'lp.price.sub':
    'Deposit any amount; it is spent only as you use it. No subscription, no per-seat fees.',
  'lp.price.c1title': 'Live conversation',
  'lp.price.c1desc': 'A minute of live conversation.',
  'lp.price.c2title': 'Voice · TTS',
  'lp.price.c2desc': 'Each minute the AI speaks.',
  'lp.price.c3title': 'Recognition · STT',
  'lp.price.c3desc': 'Each minute the AI listens.',
...
const ru: Dict = {
  ...
  'lp.roicalc.min': 'мин',
  'lp.roicalc.salary': 'Зарплата оператора в месяц',
  'lp.roicalc.operators': 'Число операторов',
  'lp.roicalc.minutes': 'Минут ИИ в месяц',
  'lp.roicalc.assumes':
    'ИИ обрабатывает звонки параллельно и без смен — вы платите только за использованные минуты.',
  'lp.roicalc.humanCost': 'Ваши расходы на зарплату',
  'lp.roicalc.aiCost': 'CallMind AI — использование',
  ...
  'lp.price.title': 'Оплата за минуту — пополните и работайте',
  'lp.price.sub':
    'Внесите любую сумму — она расходуется по мере использования. Без подписки и оплаты за место.',
  'lp.price.c1title': 'Живой разговор',
  'lp.price.c1desc': 'Минута живого разговора.',
  'lp.price.c2title': 'Голос · TTS',
  'lp.price.c2desc': 'Каждая минута речи ИИ.',
  'lp.price.c3title': 'Распознавание · STT',
  'lp.price.c3desc': 'Каждая минута распознавания.',
...
const uz: Dict = {
  ...
  'lp.roicalc.min': 'daq',
  'lp.roicalc.salary': 'Operatorning oylik maoshi',
  'lp.roicalc.operators': 'Operatorlar soni',
  'lp.roicalc.minutes': 'AI ishlaydigan daqiqa/oy',
  'lp.roicalc.assumes':
    'AI qo‘ng‘iroqlarni parallel va smenasiz bajaradi — faqat ishlatilgan daqiqa uchun to‘laysiz.',
  'lp.roicalc.humanCost': 'Oylik ish haqi xarajatingiz',
  'lp.roicalc.aiCost': 'CallMind AI — foydalanish',
  'lp.roicalc.saving': 'Oyiga tejaysiz',
  ...
  'lp.price.title': 'Daqiqasiga to‘lov — to‘ldiring va ishlating',
  'lp.price.sub':
    'Istalgan summani kiriting — faqat ishlatgancha yechiladi. Obuna va o‘rin to‘lovi yo‘q.',
  'lp.price.c1title': 'Jonli suhbat',
  'lp.price.c1desc': 'Bir daqiqa jonli suhbat.',
  'lp.price.c2title': 'Ovoz · TTS',
  'lp.price.c2desc': 'AI gapiradigan har daqiqa.',
  'lp.price.c3title': 'Tanish · STT',
  'lp.price.c3desc': 'AI eshitadigan har daqiqa.',
...
const uzCyrl: Dict = {
  ...
  'lp.roicalc.min': 'дақ',
  'lp.roicalc.salary': 'Операторнинг ойлик маоши',
  'lp.roicalc.operators': 'Операторлар сони',
  'lp.roicalc.minutes': 'AI ишлайдиган дақиқа/ой',
  'lp.roicalc.assumes':
    'AI қўнғироқларни параллел ва сменасиз бажаради — фақат ишлатилган дақиқа учун тўлайсиз.',
  'lp.roicalc.humanCost': 'Ойлик иш ҳақи харажатингиз',
  'lp.roicalc.aiCost': 'CallMind AI — фойдаланиш',
  'lp.roicalc.saving': 'Ойига тежайсиз',
  ...
  'lp.price.title': 'Дақиқасига тўлов — тўлдиринг ва ишлатинг',
  'lp.price.sub':
    'Исталган суммани киритинг — фақат ишлатгунча ечилади. Обуна ва ўрин тўлови йўқ.',
  'lp.price.c1title': 'Жонли суҳбат',
  'lp.price.c1desc': 'Бир дақиқа жонли суҳбат.',
  'lp.price.c2title': 'Овоз · TTS',
  'lp.price.c2desc': 'AI гапирадиган ҳар дақиқа.',
  'lp.price.c3title': 'Таниш · STT',
  'lp.price.c3desc': 'AI эшитадиган ҳар дақиқа.',
