...
/**
 * Shared balance / rates / activity content. Rendered by both the full
 * `/app/billing` page and the intercepted (.)billing modal so the two can
 * never drift out of sync (the modal used to show a stale USD plan view).
 */
